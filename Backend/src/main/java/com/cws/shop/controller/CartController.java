...
public class CartController {
    ...
    public ResponseEntity<ApiResponse<CartResponse>> updateQuantity(@Valid @PathVariable Long cartItemId, @RequestBody UpdateCartQuantityRequest request) {

        return ResponseEntity.ok(
                cartService.updateQuantity(cartItemId, request.getQuantity(), getAuthenticatedUserId()));
    }
}
